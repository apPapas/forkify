...
var _paginatioViewJs = require("./views/paginatioView.js");
var _paginatioViewJsDefault = parcelHelpers.interopDefault(_paginatioViewJs);
...
const constrolSearchResults = async function() {
    try {
        ...
        (0, _paginatioViewJsDefault.default).render(_modelJs.state.search);
    } catch (err) {
        console.log(err);
    }
};
...
const init = function() {
    ...
    (0, _searchViewJsDefault.default).addHandlerSearch(constrolSearchResults);
    (0, _paginatioViewJsDefault.default).addHandlerClick(controlPagination);
    (0, _addRecipeViewJsDefault.default).addHandlerUpload(controlAddRecipe);
// controlServings();
};
init();

},{"core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","./model.js":"Y4A21","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/paginatioView.js":"7lepL","./views/bookmarksView.js":"4Lqzq","./views/addRecipeView.js":"i6DNj","./config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
const KEY = "21ac7105-1634-438d-8e8c-c4c597e8999a";
...
class RecipeView extends (0, _viewJsDefault.default) {
  ...
  <div class="recipe__ingredients">
    ...
    ${this._data.ingredients.map((ing)=>{
      ...
      <div class="recipe__quantity">${ing.quantity === null ? "-" : ing.quantity.toFixed(2)}</div>
...
},{"regenerator-runtime":"dXNgZ","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9OQAM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SearchView {
...
},{"./View.js":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7lepL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
